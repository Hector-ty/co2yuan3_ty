...
| **化石燃料燃烧 (直接排放)** |                                                                                                                                               |                     |                              |
|                              | ​**固体燃料**​: 无烟煤、烟煤、褐煤                                                                       | 吨 (t)              |                              |
|                              | ​**液体燃料**​: 燃料油、汽油(非车辆)、柴油(非车辆)、煤油、液化石油气、液化天然气 | 吨 (t)              | 严格区分，此为固定设施用燃料 |
|                              | ​**气体燃料**​: 天然气、焦炉煤气、管道煤气                                                                                       | 立方米 (m³)        | 注意计算时的单位换算         |
...
|                    | 液化石油气（t）   | 2.92                                    |
|                    | 液化天然气（t）   | 2.59                                    |
|                    | **已弃用**: 原油(crudeOil)、石脑油(naphtha)、沥青(asphalt)、润滑油(lubricants)、石油焦(petroleumCoke)、石化原料油(petrochemicalFeedstock)、其他油品(otherOils) 已从系统中删除 |
| **气体燃料** | 天然气（m³）     | 21.62                                   |
...
* ​**间接排放 (注意单位换算)**​:
  * ​**电力**​: `排放量(tCO₂) = 净外购电量(10⁴kWh) × 10 MWh/10⁴kWh × 0.6849 tCO₂/MWh`。
  * ​**热力**​: `排放量(tCO₂e) = 净外购热力(GJ) × 0.11 tCO₂e/GJ`。
* ​**汇总与强度计算**​:
